...
<body>
    ...
    <div class="flex- contairner min-vh-100">
        <div class="container  shadow border-dark bg-white p-0 col-8 my-2 rounded ">
            ...
            <div class="">
                <form class="container p-4 align-content-center " action="php/teacher-add-wp.php" name="addwp"
                    ...
                    <div class="mt-2">
                        <label for="wp_tel">เบอร์โทร (เฉพาะตัวเลข)</label>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="url" class="form-control" name="map" id="map" rows="4" required>
                    </div>
                    <button class="btn btn-success form-control mt-4" type="submit" name="submit" value="Submit">
                        เพิ่มสถานประกอบการ</button>
