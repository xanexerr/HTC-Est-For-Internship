...
<body>
    ...
    <div class="container border my-2 p-4 shadow rounded">
                ...
                <label class="h4">
                    ...
                    <div>
                        ...
                        if ($resultComments->num_rows > 0) {
                            echo "<p class='h4 my-3'>ความคิดเห็น</p>";
                            $commentCount = 0;
                            while ($comment = $resultComments->fetch_assoc()) {
                                echo "<div class='mb-2'>
                <p class='mb-0 text-secondary'>ความคิดเห็นที่ " . ($commentCount + 1) . " : " . $comment['comment_text'] . "</p>
              </div>";
                                $commentCount++;
                            }
                        } else {
